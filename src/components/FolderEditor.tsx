...
export const FolderEditor = ({ onClose }: FolderEditorProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 dark:bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-zinc-700 rounded-xl p-6 w-full max-w-md">
                  ...
                  <Draggable key={folder.id} draggableId={folder.id} index={index}>
                    {provided => (
                      <div
                        ...
                        className="flex items-center gap-2 p-2 hover:bg-zinc-100 dark:hover:bg-zinc-600 rounded-xl"
                      >
