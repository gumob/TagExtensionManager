...
const Metrics: FC<MetricsProps> = ({ extensions = [] }) => {
  ...
  return (
    <div className="flex flex-row w-full gap-2">
      <div className="flex-1 bg-white dark:bg-zinc-700 rounded-xl p-2">
        <h3 className="text-xs font-semibold text-zinc-900 dark:text-white mb-1">Total</h3>
        <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{total}</p>
      </div>

      <div className="flex-1 bg-white dark:bg-zinc-700 rounded-xl p-2">
        <h3 className="text-xs font-semibold text-zinc-900 dark:text-white mb-1">Enabled</h3>
        <p className="text-lg font-bold text-green-600 dark:text-green-400">{enabled}</p>
      </div>

      <div className="flex-1 bg-white dark:bg-zinc-700 rounded-xl p-2">
        <h3 className="text-xs font-semibold text-zinc-900 dark:text-white mb-1">Disabled</h3>
